...
from app.api.routes import chat, tables, query, auth, targets, ai, channels, smartstore, cafe24, coupang_wing, coupang_rocket, analytics, market_analysis, campaign_planner, settlement, scm, sabangnet, sabangnet_mapping, sabangnet_voice_cs, csa, inventory, admin, purchase, management
