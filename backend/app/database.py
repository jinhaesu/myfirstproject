...
def init_db():
    ...
    if engine is not None:
        ...
        from app.db_models import (  # noqa: F401
            ...
            PurchaseAssetLocation, PurchaseAssetItem, PurchaseAssetLedger,
        ...
        try:
            ...
            with engine.connect() as conn:
                ...
                conn.execute(text("ALTER TABLE purchase_record ADD COLUMN IF NOT EXISTS team VARCHAR(20) DEFAULT '구매팀'"))
                conn.commit()
        except Exception:
            pass
