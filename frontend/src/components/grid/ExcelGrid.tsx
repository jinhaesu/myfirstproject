          ...
          <thead className="bg-slate-100 sticky top-0 z-10">
            <tr>
              ...
              {columns.map((col, i) => (
                <th
                  key={i}
                  className="border-r border-b border-slate-200 px-3 py-2 text-center text-sm font-semibold text-slate-700 min-w-[80px]"
                >
                  {col}
                </th>
              ))}
                ...
                >
                  {editingCell?.row === rowIndex && editingCell?.col === 0 ? (
                    <input
                      ...
                      autoFocus
                      className="w-full px-2 py-1 text-sm border-0 outline-none bg-white"
                    />
                  ) : (
                    <div className="px-2 py-1 text-sm text-slate-800 min-h-[28px]">
                      {row[0] || ''}
                    </div>
                  )}
                </td>
                    ...
                    >
                      {isEditing ? (
                        <input
                          ...
                          onBlur={() => setEditingCell(null)}
                          autoFocus
                          className="w-full px-2 py-1 text-sm border-0 outline-none bg-white text-right"
                        />
                      ) : (
                        <div className="px-2 py-1 text-sm text-slate-800 text-right min-h-[28px]">
                          {row[cellIndex] || ''}
                        </div>
                      )}
                    </td>
